  ...
  return (
    <div className="bg-black">
      <div className="max-w-[1300px] mx-auto px-4 py-6">
        ...
        <div className="text-lg font-semibold flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between items-center">
          <div class="text-white">
            COPYRIGHT BY@SLIDESIGMA
          </div>
          <div>
            <div className="icons-container flex">
              <div className="flex flex-row items-center space-x-6 bg-[#212121] mx-2 hover:bg-[#bead8e] p-6">
                <svg
